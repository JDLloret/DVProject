...
This can clearly be seen at iteration 2, since there is almost no visible clustering whereas in iteration 20000, the clusters are highly distinct (even overly refined) The intermediate iterations show a progressive improvement, with increasingly well-defined clusters.
